        ...
        return (
            <div>
                ...
                <div id="faqDiv">
                    ...
                    <p id="results" style={{ color: 'white' }}> results </p>
                    ...
                    <div id="resultsFAQSectionContainer1">
                        ...
                        <div id="resultsFAQAnswer1">
                            <p class="FAQ-Answer" style={{ marginLeft: '2.5rem' }}><strong>Recommended System Specifications:</strong></p>
                            <p class="FAQ-Answer" style={{ marginLeft: '2.5rem', marginBottom: '0.5rem' }}>The data you provide is run through an optimization model that seeks to minimize cost spent on electricity over 25 years. The model outputs the optimal size of installation, and Soli calculates the following information.</p>
                            <p class="FAQ-Answer" style={{ marginLeft: '4rem', marginBottom: '0.5rem' }}><strong> Installation Size</strong> → The model outputs the optimal size of installation which takes the optimal number of solar panels and multiplies it by the capacity of one solar panel.</p>
                            <p class="FAQ-Answer" style={{ marginLeft: '4rem', marginBottom: '0.5rem' }}><strong> Initial Investment</strong> → Soli calculates the resulting initial investment by multiplying the installation size by the cost per kW of solar panels plus an additional fixed cost of installation. </p>
                            <p class="FAQ-Answer" style={{ marginLeft: '4rem', marginBottom: '0.5rem' }}><strong> Payback Period</strong> → The payback period represents the estimated number of years it will take for you to recover the cost of the initial investment through savings generated by solar.</p>

                            <p class="FAQ-Answer" style={{ marginLeft: '2.5rem' }}><strong>Savings:</strong></p>
                            <p class="FAQ-Answer" style={{ marginLeft: '2.5rem', marginBottom: '0.5rem' }} >Soli calculates the difference between your projected cost of electricity overtime, with and without solar.</p>
                            <p class="FAQ-Answer" style={{ marginLeft: '4rem', marginBottom: '0.5rem' }}><strong> Total Savings</strong> → This is the sum of the calculated differences between your project cost of electricity overtime, with and without solar.</p>
                            <p class="FAQ-Answer" style={{ marginLeft: '4rem', marginBottom: '0.5rem' }}><strong> Seasonal Savings Breakdown</strong> → Your potential savings are also broken down by season to give you an idea of the fluctuations in cost savings by season over 25 years. These values are calculated by taking the average savings by season over the 25 year time frame. </p>

                            <p class="FAQ-Answer" style={{ marginLeft: '2.5rem' }}><strong>Environmental Impact:</strong></p>
                            <p class="FAQ-Answer" style={{ marginLeft: '2.5rem', marginBottom: '0.5rem' }}>Using solar energy in place of electricity from the grid will reduce your carbon emissions overtime. Soli quantifies this in terms of metric tonnes of carbon, and the equivalent in tree plantings.</p>
                            <p class="FAQ-Answer" style={{ marginLeft: '4rem', marginBottom: '0.5rem' }}><strong> Carbon Reduction</strong> → To calculate the estimated amount of carbon reduced, the difference in electricity usage from the grid with and without solar panels is calculated and multiplied by a factor that represents the amount of CO2/kWh of electricity from the grid.</p>
                            <p class="FAQ-Answer" style={{ marginLeft: '4rem', marginBottom: '0.5rem' }}><strong> Tree Plantings</strong> → The equivalency of the carbon reduction in tree plantings is calculated by multiplying the estimated amount of carbon reduction by a factor that represents the number of trees needed to offset 1 tonne of CO2. </p>
                        </div>
                    </div>
