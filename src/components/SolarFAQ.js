                ...
                <div id="faqDiv">
                    ...
                    <div id="resultsFAQSectionContainer1">
                        ...
                        <div id="resultsFAQAnswer1">
                            <p class="FAQ-Answer" style={{marginLeft: '2.5rem'}}><strong>Recommended System Specification</strong></p>
                            ...
                            <p class="FAQ-Answer" style={{marginLeft: '3.5em', marginBottom: '0.5rem' }}><strong> Installation Size:</strong> The model outputs the optimal size of installation which takes the optimal number of solar panels and multiplies it by the capacity of one solar panel.</p>
                            <p class="FAQ-Answer" style={{marginLeft: '3.5rem', marginBottom: '0.5rem' }}><strong> Initial Investment:</strong> Soli calculates the resulting initial investment by multiplying the installation size by the cost per kW of solar panels plus an additional fixed cost of installation. </p>
                            <p class="FAQ-Answer" style={{marginLeft: '3.5rem', marginBottom: '0.5rem' }}><strong> Payback Period</strong> The payback period represents the estimated number of years it will take for you to recover the cost of the initial investment through savings generated by solar.</p>
