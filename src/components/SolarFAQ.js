...
class SolarFAQ extends Component {
    render() {
        ...
        window.addEventListener('load', function () {
            ...
            if (oldURL.localeCompare(startSaving) == 0) {
                ...
                <div id="faqDiv">
                    ...
                    <div id="resultsFAQSectionContainer1">
                        ...
                        <div id="resultsFAQAnswer1">
                            <p class="FAQ-Answer"><strong>Recommended System Specification</strong></p>
                            <p class="FAQ-Answer">The data you provide is run through an optimization model that seeks to minimize cost spent on electricity over 25 years. The model outputs the optimal size of installation, and Soli calculates the resulting initial investment, and payback period.</p>
                            <br></br>

                            <p class="FAQ-Answer"><strong>Savings</strong></p>
                            <p class="FAQ-Answer">Soli calculates the difference between your projected cost of electricity overtime, with and without solar. The sum of the difference over 25 years amounts to the savings figure over a 25 year time horizon. Your savings/month in each season, averaged over 25 years are also available.</p>
                            <br></br>

                            <p class="FAQ-Answer"><strong>Environmental Impact</strong></p>
                            <p class="FAQ-Answer">Using solar energy in place of electricity from the grid will reduce your carbon emissions overtime. Soli quantifies this in terms of metric tonnes of carbon, and the equivalent in tree plantings.</p>
                        </div>
                    </div>
